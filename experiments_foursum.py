...
INSTANCES: List[Tuple[str, str]] = [
    ('fourSum_quartic', 'foursum/app/build/libs/app.jar'),
    ('fourSum_cubic', 'foursum/app/build/libs/app.jar'),
    ('fourSum_hashmap', 'foursum/app/build/libs/app.jar')
]
...
if __name__ == '__main__':
    ...
    with open('results_foursum.csv', 'w') as f:
