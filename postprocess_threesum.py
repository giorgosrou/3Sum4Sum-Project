...
def plot_algorithms_threesum(res: Dict[str, np.ndarray],
                             filename: str):
    (fig, ax) = plt.subplots()
...
if __name__ == '__main__':
    raw_results: Dict[str, Dict[int, List[float]]] = \
        read_results('results_threesum.csv')
    ...
    write_latex_tabular(
        refined_results['quadratic'], 'threesum_quadratic_tabular.tex')
    write_latex_tabular(
        refined_results['hashmap'], 'threesum_hashmap_tabular.tex')

    plot_algorithms_threesum(refined_results, 'Plot_threesum.pdf')
